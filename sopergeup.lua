...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == 'yes' then
    ...
    local link = "https://telegram.me/"..msg.from.username..'\n'
local inline_text = ""..msg.from.first_name..'\n'
local keyboard = {}
...
send_api_keyboard(msg, get_receiver_api(msg),text, keyboard)
    ...
    save_data(_config.moderation.data, data)
    local text = 'تم ✅ تفعيل منع الاعلانات 🔒📱️'..'\n'
    local link = "https://telegram.me/"..msg.from.username..'\n'
local inline_text = ""..msg.from.first_name..'\n'
local keyboard = {}
keyboard.inline_keyboard = {
...
send_api_keyboard(msg, get_receiver_api(msg),text, keyboard)
		...
		if matches[1] == 'setphoto' and is_momod(msg) then
			...
			local text = 'قم بأرسال 📩 الصورة الان 🎆✔️'..'\n\n'
			local link = "https://telegram.me/"..msg.from.username..'\n'
local inline_text = ""..msg.to.title..'\n'
local keyboard = {}
keyboard.inline_keyboard = {
{
{text = inline_text, url = link },
...
send_api_keyboard(msg, get_receiver_api(msg),text, keyboard)
					...
					local text = "منع ❌ الصور المتحركة مفعل سابقا 🔒🌌"..'\n'
					local link = "https://telegram.me/"..msg.from.username..'\n'
local inline_text = ""..msg.from.first_name..'\n'
local keyboard = {}
keyboard.inline_keyboard = {
...
send_api_keyboard(msg, get_receiver_api(msg),text, keyboard)
			...
			local msg_type = 'Document'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					local text = "تم ✅ تفعيل منع الملفات 🔒📂"..'\n'
					local link = "https://telegram.me/"..msg.from.username..'\n'
local inline_text = ""..msg.from.first_name..'\n'
local keyboard = {}
keyboard.inline_keyboard = {
...
send_api_keyboard(msg, get_receiver_api(msg),text, keyboard)
					...
					local text = "منع ❌ الدردشة مفعل سابقا 🔒🔕"..'\n'
					local link = "https://telegram.me/"..msg.from.username..'\n'
local inline_text = ""..msg.from.first_name..'\n'
local keyboard = {}
keyboard.inline_keyboard = {
...
send_api_keyboard(msg, get_receiver_api(msg),text, keyboard)
					...
					local text = "قفل المحادثه 👥 مفعل سابقا 🔒✔️"..'\n'
					local link = "https://telegram.me/"..msg.from.username..'\n'
local inline_text = ""..msg.from.first_name..'\n'
local keyboard = {}
keyboard.inline_keyboard = {
			...
			local msg_type = 'Audio'
				if is_muted(chat_id, msg_type..': yes') then
					...
					unmute(chat_id, msg_type)
						local text = "تم ✅ الغاء تفعيل منع الصوتيات 🔓📢"..'\n'
				local link = "https://telegram.me/"..msg.from.username..'\n'
local inline_text = ""..msg.from.first_name..'\n'
local keyboard = {}
keyboard.inline_keyboard = {
